"""
Django settings for category_manager project.
...
SECRET_KEY = 'django-insecure-*%9^x0%los-4%p1w0u8hf!wf6oh@wgh@hn!ryyum#18l*xu=t8'
...
ROOT_URLCONF = 'category_manager.urls'
...
WSGI_APPLICATION = 'category_manager.wsgi.application'
